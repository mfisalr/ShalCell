...
<head>
    ...
    <title>{{ __('Create account') }} | {{ config('app.name', 'ShalCell') }}</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .register-shell { display: grid; grid-template-columns: minmax(320px, .9fr) minmax(460px, 1.1fr); min-height: 100vh; }
        .register-intro { position: relative; display: flex; align-items: flex-end; min-height: 100%; padding: 48px clamp(32px, 7vw, 104px); overflow: hidden; background: linear-gradient(145deg, rgba(52, 71, 103, .92), rgba(121, 40, 202, .78)), url('{{ asset('img/curved-images/curved14.jpg') }}') center / cover; }
        .register-intro::after { position: absolute; width: 360px; height: 360px; right: -150px; top: 16%; border: 1px solid rgba(255, 255, 255, .2); border-radius: 50%; content: ''; }
        .intro-content { position: relative; z-index: 1; max-width: 470px; color: #fff; }
        .brand { position: absolute; top: 42px; left: clamp(32px, 7vw, 104px); color: #fff; font-family: 'Manrope', sans-serif; font-size: 1.25rem; font-weight: 800; letter-spacing: .12em; }
        ...
        .register-panel { display: flex; align-items: center; padding: 48px clamp(28px, 8vw, 120px); background: #fff; }
        ...
        .terms { display: flex; align-items: flex-start; gap: 10px; margin: 4px 0 24px; color: var(--muted); font-size: .83rem; line-height: 1.5; }
        .terms input { width: 16px; height: 16px; margin-top: 2px; accent-color: var(--accent); }
        .terms a, .login-link a { color: var(--accent); font-weight: 700; text-decoration: none; }
        ...
        .login-link { margin: 22px 0 0; color: var(--muted); font-size: .88rem; text-align: center; }
        @media (max-width: 800px) {
            .register-shell { display: block; }
            .register-intro { min-height: 330px; padding: 38px 28px; }
            .brand { top: 28px; left: 28px; }
            .intro-content { margin-top: 70px; }
            .intro-content h1 { font-size: 2.2rem; }
            .register-panel { padding: 42px 24px 56px; }
        }
    </style>
</head>
<body>
    <main class="register-shell">
        <section class="register-intro">
            ...
            <div class="intro-content">
                ...
                <p>Kelola data dan operasional dengan ruang kerja ShalCell yang lebih teratur, cepat, dan mudah digunakan.</p>
            </div>
        </section>
        <section class="register-panel">
            <div class="form-wrap">
                <h2>Buat akun baru</h2>
                <p class="form-subtitle">Daftar untuk mulai mengelola aktivitas ShalCell Anda.</p>
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name') }}" class="@error('name') is-invalid @enderror" placeholder="Masukkan nama lengkap" required autocomplete="name" autofocus>
                        </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" class="@error('email') is-invalid @enderror" placeholder="nama@perusahaan.com" required autocomplete="email">
                        </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input id="password" type="password" name="password" class="@error('password') is-invalid @enderror" placeholder="Minimal 8 karakter" required autocomplete="new-password">
                        </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input id="password-confirm" type="password" name="password_confirmation" placeholder="Ulangi password Anda" required autocomplete="new-password">
                        </div>
                    </div>
                    <label class="terms">
                        <input type="checkbox" required>
                        <span>Saya menyetujui <a href="#">syarat dan ketentuan</a> yang berlaku.</span>
                    </label>
